...
function breathingAnimation() {
  document.getElementById('breathingCircle').style.animation = "circleAnimation 12s 10";
}
...
function showScore(){
  console.log(window.localStorage.getItem('score'));
  document.getElementById('score').innerHTML = "Your Score is: " + window.localStorage.getItem('score'); 
